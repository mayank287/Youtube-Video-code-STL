...
void Mayank() 
{
 ...
 // 1> Accumulate()
 // for Vector
 cout << accumulate(v.begin(),v.end(),0) << nline;
 // for Array
 cout << accumulate(arr,arr + n,0) << nline;
 // ----------------------------------------------- //
 // 2> Find()
 ...
 // 3> Count
 // For Vector
 cout << count(v.begin(),v.end(),2) << nline;
 // For Array
 cout << count(arr,arr + n, 2) << nline;
 // --------------------------------------------------------//
 // 4> and 5> max_element and min_element
 // For Vector
